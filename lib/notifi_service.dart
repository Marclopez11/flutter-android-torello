...
class NotifiService {
  ...
  static void openNotification(NotificationResponse notificationResponse) async {
    print(notificationResponse.toString());
    String link = notificationResponse.payload ?? '';
    ...
    if (link != '') {
      ...
      //if (urllaunchable) {
        await launchUrlString(link); //launch is from url_launcher package to launch URL
      //} else {
      await launchUrlString(link); // Suponiendo que tienes la función launchUrlString
      //}
    }
  }
